 ...
 *
 * $Id: Win32.cs,v 1.1 2010/11/19 15:40:51 kzmi Exp $
 */
using System;
...
namespace Telnet
{
	...
	public class Win32 {
		...
		public static void ClearFPUOverflowFlag() {
			_controlfp(0x9001f, 0xfffff); //JSPager–â‘è‚Ì‘Î‰žBî•ñ‚Íhttp://support.microsoft.com/default.aspx?scid=kb;en-us;326219
		}
		...
		//GetSystemMetrics‚É“n‚·’è”B‚Æ‚è‚ ‚¦‚¸•K—v‚È•ª‚¾‚¯
...
*/
        ...
        //WM_COPYDATA‚Åƒtƒ@ƒCƒ‹‚ðŠJ‚­‚Æ‚«‚ÌƒƒbƒZ[ƒW ”’lŽ©‘Ì‚ÉˆÓ–¡‚Í‚È‚¢B•Ê‚ÌƒAƒvƒŠƒP[ƒVƒ‡ƒ“‚Æ‹ô‘R‚©‚Ô‚ç‚È‚¢‚æ‚¤‚É‚·‚é‚±‚Æ‚¾‚¯‚ª–Ú“I
