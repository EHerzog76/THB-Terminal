/*s
 ...
 $Id: Tutorial.cs,v 1.1 2010/11/19 15:40:39 kzmi Exp $
*/
using System;
using System.IO;
using System.Text;
...
namespace Granados.Tutorial
{
	...
	class Tutorial
	{
		...
		private static void ConnectSSH2AndPortforwarding() {
			...
			reader._pf = ch;
			while(!reader._ready) System.Threading.Thread.Sleep(100); //wait response
        ...
        private static void AgentForward() {
            ...
            while(!reader._ready) Thread.Sleep(100);
