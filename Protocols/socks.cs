...
* $Id: socks.cs,v 1.1 2010/11/19 15:41:03 kzmi Exp $
*/
using System;
using System.Text;
...
namespace Protocols
{
	public class Socks {
		...
		private string _destName;       //_destName, _destAddress‚Í‚Ç‚¿‚ç‚©‚Ì‚ÝŽg—p
		...
		private void ConnectBySocks4(Socket s) {
			...
			if(_destAddress==null) { //host‚ªŽw’è‚³‚ê‚½
				//ˆÈ‰º‚Å‚æ‚¢‚ÆŽv‚Á‚½‚ªA‚Ç‚¤‚à“®‚©‚È‚¢BƒvƒƒgƒRƒ‹4a‚Æ‚¢‚¤‚â‚Â‚ªƒTƒ|[ƒg‚³‚ê‚Ä‚¢‚È‚¢‚Ì‚©H
